...
public class viewWindowCreatePartidaD extends JFrame {
	...
	/**
	 * Crea la ventana.
	 * @param jugador      el mensaje de bienvenida
	 * @param res      el ID de expediente del jugador
	 * @param color
	 */
	public viewWindowCreatePartidaD(Jugador jugador, int[][] res, Colour color) {
		...
		btnVolver.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dispose();
				viewWindowJuego vwp = new viewWindowJuego(jugador);
				vwp.setVisible(true);
			}
		});
